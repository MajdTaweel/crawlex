defmodule CrawlexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CrawlexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CrawlexWeb.Gettext, "errors", msg, opts)
    end
  end
